...
\date{\href{http://www.meetup.com/Web-Performance-Boston/events/175333442/}{Boston WebPerf Meetup} / 2014-04-22}
...
\splashimage[0.95]{meetup-wpt}{\sn{0.1} Start Measuring}

\splashimage[0.75]{wpt-mpulse}{Or use RUM for real user data (boomerang/mPulse)}
...
\splashimage[0.7]{meetup-wpt-waterfall}{\sn{1.4} Parallelise downloads}{\textrm{\textit{You can have higher bandwidth, you cannot have lower latency.}}}
