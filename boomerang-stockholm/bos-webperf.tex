...
\splashslide[\sn{1}Blinking Lights]{ It takes about 16ms for light to get from SF to Boston \\ (24ms through fibre) \\ \vspace{1em} \only<1>{ \ldots } \only<2>{Though it takes about 100ms to ping... why?} }
