...
\date{\href{http://www.paris-web.fr/2014/conferences/frontend-performance-beginner-to-expert-to-crazy-person.php}{Paris-Web 2014} / 2014-10-17}
...
\splashimage[0.94]{paris-web-wpt}{\sn{0.1} Start Measuring}
...
\splashimage[1.01]{pw-wpt-two-connections}{\sn{1.1} Google Chrome will open two TCP connections to the primary host, one for the page, and the second "just in case"}{}
...
\splashimage[0.7]{pw-audits}{\sn{1.3} Audit your CSS}{\textrm{\textit{Chrome WebDev tools}}}
...
\splashimage[0.8]{pw-wpt-waterfall}{\sn{1.4} Parallelise downloads/use sprites}{\textrm{\textit{You can have higher bandwidth, you cannot have lower latency.}}}
