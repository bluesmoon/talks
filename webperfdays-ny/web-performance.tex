...
\title{FE Performance: Expert to Crazy Person}

\date{\href{http://www.webperfdays.org/events/2014-newyork/index.html}{WebPerfDays New York} / 2014-09-18}
...
\splashimage[1]{wpd-wpt}{\sn{0.1} Start Measuring}

\splashimage[0.85]{wpt-mpulse}{Or use RUM for real user data (boomerang/mPulse)}

\splashslide{You already compress, minify and cache aggressively, right?}
...
\splashimage[0.8]{wpd-audits}{\sn{1.3} Audit your CSS}{\textrm{\textit{Chrome WebDev tools}}}

\splashslide{Also checkout \href{https://github.com/giakki/uncss}{\green<1>{uncss}} for a command line option}

\splashimage[0.7]{wpd-wpt-waterfall}{\sn{1.4} Parallelise downloads/use sprites}{\textrm{\textit{You can have higher bandwidth, you cannot have lower latency.}}}
