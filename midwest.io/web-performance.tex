...
\date{\href{http://www.midwest.io/}{Midwest.io} / 2014-07-14}
...
\splashimage[0.80]{google-fiber-kc}{Bandwidth}
...
\splashimage[1]{midwest-wpt}{\sn{0.1} Start Measuring}

\splashimage[0.92]{Jean-Antoine_Nollet}{Or use RUM for real user data (old skool)}
...
\splashimage[0.8]{midwest-audits}{\sn{1.3} Audit your CSS}{\textrm{\textit{Chrome WebDev tools}}}

\splashslide{Also checkout \href{https://github.com/giakki/uncss}{\green<1>{uncss}} for a command line option}

\splashimage[0.7]{midwest-waterfall}{\sn{1.4} Parallelise downloads/use sprites}{\textrm{\textit{You can have higher bandwidth, you cannot have lower latency.}}}
