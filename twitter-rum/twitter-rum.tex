...
\setbeamertemplate{background}{
  \parbox[c][0.94\paperheight]{\paperwidth}{
    \vfill \hfill \pgfimage[width=\paperwidth]{"navtiming-support"}
  }
}
\begin{frame}{Modern Browsers -- no problem}
\end{frame}
...
\setbeamertemplate{background}{
  \parbox[c][0.75\paperheight]{\paperwidth}{
    \vfill \hfill \pgfimage[width=0.7\paperwidth]{"its-complicated"}
  }
}
