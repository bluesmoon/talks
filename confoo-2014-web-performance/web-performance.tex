...
\date{\href{http://confoo.ca/en/2014/session/frontend-performance-beginner-to-expert-to-crazy-person}{Confoo 2014} / 2014-02-27}
...
\splashimage[0.9]{confoo-wpt}{\sn{0.1} Start Measuring}

\splashslide{Or use RUM for real user data (boomerang/mPulse)}
...
\splashimage[0.8]{confoo-audits}{\sn{1.3} Audit your CSS}{\textrm{\textit{Chrome WebDev tools}}}

\splashimage[0.7]{confoo-wpt-waterfall}{\sn{1.4} Parallelise downloads}{\textrm{\textit{You can have higher bandwidth, you cannot have lower latency.}}}
...
\splashslide[\sn{2.1b}pre-render]{\texttt{<link rel="prerender" href="url">} \\ \vfill \href{https://developers.google.com/chrome/whitepapers/prerender}{\small https://developers.google.com/chrome/whitepapers/prerender}}
